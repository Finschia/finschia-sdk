...
var (
	...
	fd_Block_entropy     protoreflect.FieldDescriptor
)

func init() {
	file_ostracon_types_block_proto_init()
	md_Block = File_ostracon_types_block_proto.Messages().ByName("Block")
	...
	fd_Block_entropy = md_Block.Fields().ByName("entropy")
}
...
func (x *Block) slowProtoReflect() protoreflect.Message {
	mi := &file_ostracon_types_block_proto_msgTypes[0]
...
func (x *fastReflection_Block) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "ostracon.types.Block.header":
		return x.Header != nil
	case "ostracon.types.Block.data":
		return x.Data != nil
	case "ostracon.types.Block.evidence":
		return x.Evidence != nil
	case "ostracon.types.Block.last_commit":
		return x.LastCommit != nil
	case "ostracon.types.Block.entropy":
		return x.Entropy != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ostracon.types.Block"))
		}
		panic(fmt.Errorf("message ostracon.types.Block does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Block) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message ostracon.types.Block does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Block) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "ostracon.types.Block.entropy":
		x.Entropy = value.Message().Interface().(*Entropy)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ostracon.types.Block"))
		}
...
func (x *fastReflection_Block) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in ostracon.types.Block", d.FullName()))
	}
	panic("unreachable")
}
...
type Block struct {
	...
	Entropy *Entropy `protobuf:"bytes,1000,opt,name=entropy,proto3" json:"entropy,omitempty"`
}
...
func (*Block) Descriptor() ([]byte, []int) {
	return file_ostracon_types_block_proto_rawDescGZIP(), []int{0}
}

func (x *Block) GetHeader() *types.Header {
	if x != nil {
		return x.Header
	}
	return nil
...
func (x *Block) GetEntropy() *Entropy {
	if x != nil {
		return x.Entropy
	}
	return nil
...
var File_ostracon_types_block_proto protoreflect.FileDescriptor

var file_ostracon_types_block_proto_rawDesc = []byte{
	0x0a, 0x1a, 0x6f, 0x73, 0x74, 0x72, 0x61, 0x63, 0x6f, 0x6e, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73,
	0x2f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0e, 0x6f, 0x73,
	0x74, 0x72, 0x61, 0x63, 0x6f, 0x6e, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x1a, 0x14, 0x67, 0x6f,
	0x67, 0x6f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x1a, 0x1a, 0x6f, 0x73, 0x74, 0x72, 0x61, 0x63, 0x6f, 0x6e, 0x2f, 0x74, 0x79, 0x70,
	...
	0x73, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa8, 0x02,
	0x0a, 0x05, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x36, 0x0a, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65,
	...
	0x30, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e,
	...
	0x61, 0x12, 0x40, 0x0a, 0x08, 0x65, 0x76, 0x69, 0x64, 0x65, 0x6e, 0x63, 0x65, 0x18, 0x03, 0x20,
	...
	0x69, 0x74, 0x52, 0x0a, 0x6c, 0x61, 0x73, 0x74, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x12, 0x38,
	0x0a, 0x07, 0x65, 0x6e, 0x74, 0x72, 0x6f, 0x70, 0x79, 0x18, 0xe8, 0x07, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x17, 0x2e, 0x6f, 0x73, 0x74, 0x72, 0x61, 0x63, 0x6f, 0x6e, 0x2e, 0x74, 0x79, 0x70, 0x65,
	0x73, 0x2e, 0x45, 0x6e, 0x74, 0x72, 0x6f, 0x70, 0x79, 0x42, 0x04, 0xc8, 0xde, 0x1f, 0x00, 0x52,
	0x07, 0x65, 0x6e, 0x74, 0x72, 0x6f, 0x70, 0x79, 0x42, 0xae, 0x01, 0x0a, 0x12, 0x63, 0x6f, 0x6d,
	0x2e, 0x6f, 0x73, 0x74, 0x72, 0x61, 0x63, 0x6f, 0x6e, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x42,
	...
	0x61, 0x70, 0x69, 0x2f, 0x6f, 0x73, 0x74, 0x72, 0x61, 0x63, 0x6f, 0x6e, 0x2f, 0x74, 0x79, 0x70,
	0x65, 0x73, 0xa2, 0x02, 0x03, 0x4f, 0x54, 0x58, 0xaa, 0x02, 0x0e, 0x4f, 0x73, 0x74, 0x72, 0x61,
	0x63, 0x6f, 0x6e, 0x2e, 0x54, 0x79, 0x70, 0x65, 0x73, 0xca, 0x02, 0x0e, 0x4f, 0x73, 0x74, 0x72,
	0x61, 0x63, 0x6f, 0x6e, 0x5c, 0x54, 0x79, 0x70, 0x65, 0x73, 0xe2, 0x02, 0x1a, 0x4f, 0x73, 0x74,
	0x72, 0x61, 0x63, 0x6f, 0x6e, 0x5c, 0x54, 0x79, 0x70, 0x65, 0x73, 0x5c, 0x47, 0x50, 0x42, 0x4d,
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x0f, 0x4f, 0x73, 0x74, 0x72, 0x61, 0x63,
	0x6f, 0x6e, 0x3a, 0x3a, 0x54, 0x79, 0x70, 0x65, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}

var (
	file_ostracon_types_block_proto_rawDescOnce sync.Once
	file_ostracon_types_block_proto_rawDescData = file_ostracon_types_block_proto_rawDesc
)

func file_ostracon_types_block_proto_rawDescGZIP() []byte {
	file_ostracon_types_block_proto_rawDescOnce.Do(func() {
		file_ostracon_types_block_proto_rawDescData = protoimpl.X.CompressGZIP(file_ostracon_types_block_proto_rawDescData)
	})
	return file_ostracon_types_block_proto_rawDescData
}

var file_ostracon_types_block_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_ostracon_types_block_proto_goTypes = []interface{}{
	(*Block)(nil),              // 0: ostracon.types.Block
	(*types.Header)(nil),       // 1: tendermint.types.Header
	...
	(*Entropy)(nil),            // 5: ostracon.types.Entropy
}
var file_ostracon_types_block_proto_depIdxs = []int32{
	1, // 0: ostracon.types.Block.header:type_name -> tendermint.types.Header
	2, // 1: ostracon.types.Block.data:type_name -> tendermint.types.Data
	3, // 2: ostracon.types.Block.evidence:type_name -> tendermint.types.EvidenceList
	4, // 3: ostracon.types.Block.last_commit:type_name -> tendermint.types.Commit
	5, // 4: ostracon.types.Block.entropy:type_name -> ostracon.types.Entropy
...
func init() { file_ostracon_types_block_proto_init() }
func file_ostracon_types_block_proto_init() {
	if File_ostracon_types_block_proto != nil {
		return
	}
	file_ostracon_types_types_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_ostracon_types_block_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Block); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_ostracon_types_block_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_ostracon_types_block_proto_goTypes,
		DependencyIndexes: file_ostracon_types_block_proto_depIdxs,
		MessageInfos:      file_ostracon_types_block_proto_msgTypes,
	}.Build()
	File_ostracon_types_block_proto = out.File
	file_ostracon_types_block_proto_rawDesc = nil
	file_ostracon_types_block_proto_goTypes = nil
	file_ostracon_types_block_proto_depIdxs = nil
}
