...
const (
	Service_GetNodeInfo_FullMethodName             = "/lbm.base.ostracon.v1.Service/GetNodeInfo"
	Service_GetSyncing_FullMethodName              = "/lbm.base.ostracon.v1.Service/GetSyncing"
	Service_GetLatestBlock_FullMethodName          = "/lbm.base.ostracon.v1.Service/GetLatestBlock"
	Service_GetBlockByHeight_FullMethodName        = "/lbm.base.ostracon.v1.Service/GetBlockByHeight"
	Service_GetBlockByHash_FullMethodName          = "/lbm.base.ostracon.v1.Service/GetBlockByHash"
	Service_GetBlockResultsByHeight_FullMethodName = "/lbm.base.ostracon.v1.Service/GetBlockResultsByHeight"
	Service_GetLatestValidatorSet_FullMethodName   = "/lbm.base.ostracon.v1.Service/GetLatestValidatorSet"
	Service_GetValidatorSetByHeight_FullMethodName = "/lbm.base.ostracon.v1.Service/GetValidatorSetByHeight"
)
...
func (c *serviceClient) GetBlockByHash(ctx context.Context, in *GetBlockByHashRequest, opts ...grpc.CallOption) (*GetBlockByHashResponse, error) {
	...
	err := c.cc.Invoke(ctx, Service_GetBlockByHash_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) GetBlockResultsByHeight(ctx context.Context, in *GetBlockResultsByHeightRequest, opts ...grpc.CallOption) (*GetBlockResultsByHeightResponse, error) {
	...
	err := c.cc.Invoke(ctx, Service_GetBlockResultsByHeight_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedServiceServer) GetBlockByHash(context.Context, *GetBlockByHashRequest) (*GetBlockByHashResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBlockByHash not implemented")
}
func (UnimplementedServiceServer) GetBlockResultsByHeight(context.Context, *GetBlockResultsByHeightRequest) (*GetBlockResultsByHeightResponse, error) {
...
func _Service_GetBlockByHash_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Service_GetBlockByHash_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Service_GetBlockResultsByHeight_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Service_GetBlockResultsByHeight_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
