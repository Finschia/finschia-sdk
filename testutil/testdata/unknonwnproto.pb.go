...
import (
	...
	tx "github.com/line/lfb-sdk/types/tx"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
func (m *TestUpdatedTxBody) GetSigBlockHeight() uint64 {
	if m != nil {
		return m.SigBlockHeight
	}
	return 0
}
...
var fileDescriptor_448ea787339d1228 = []byte{
	...
	,
}
...
func (m *TestUpdatedTxBody) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.SigBlockHeight != 0 {
		i = encodeVarintUnknonwnproto(dAtA, i, uint64(m.SigBlockHeight))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Messages) > 0 {
...
func (m *TestUpdatedTxBody) Size() (n int) {
	...
	if m.SigBlockHeight != 0 {
		n += 1 + sovUnknonwnproto(uint64(m.SigBlockHeight))
	}
	l = len(m.Memo)
	if l > 0 {
		n += 1 + l + sovUnknonwnproto(uint64(l))
...
func (m *TestUpdatedTxBody) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SigBlockHeight", wireType)
			}
			m.SigBlockHeight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SigBlockHeight |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
