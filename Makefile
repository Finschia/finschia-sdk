...
test-ledger-mock:
	@go test -mod=readonly `go list github.com/line/lbm-sdk/crypto` -tags='cgo ledger test_ledger_mock'

test-ledger: test-ledger-mock
	@go test -mod=readonly -v `go list github.com/line/lbm-sdk/crypto` -tags='cgo ledger'
