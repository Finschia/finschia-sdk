...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/Finschia/finschia-rdk/types/errors.Wrap",
		"github.com/Finschia/finschia-rdk/types/errors.Wrapf",
		"github.com/Finschia/finschia-rdk/types/errors.WithType",
