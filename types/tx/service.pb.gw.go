...
var (
	pattern_Service_Simulate_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"lbm", "tx", "v1beta1", "simulate"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Service_GetTx_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"lbm", "tx", "v1beta1", "txs", "hash"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Service_BroadcastTx_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"lbm", "tx", "v1beta1", "txs"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Service_GetTxsEvent_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"lbm", "tx", "v1beta1", "txs"}, "", runtime.AssumeColonVerbOpt(true)))
)
