...
type BroadcastTxRequest struct {
	...
	Mode    BroadcastMode `protobuf:"varint,2,opt,name=mode,proto3,enum=lbm.tx.v1beta1.BroadcastMode" json:"mode,omitempty"`
}
...
func (*BroadcastTxRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_6fc6bd78191bf1b3, []int{2}
}
...
func (*BroadcastTxResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_6fc6bd78191bf1b3, []int{3}
}
...
func (*SimulateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_6fc6bd78191bf1b3, []int{4}
}
...
func (*SimulateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_6fc6bd78191bf1b3, []int{5}
}
...
func (*GetTxRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_6fc6bd78191bf1b3, []int{6}
}
...
func (*GetTxResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_6fc6bd78191bf1b3, []int{7}
}
...
func init() {
	proto.RegisterEnum("lbm.tx.v1beta1.BroadcastMode", BroadcastMode_name, BroadcastMode_value)
	proto.RegisterType((*GetTxsEventRequest)(nil), "lbm.tx.v1beta1.GetTxsEventRequest")
	proto.RegisterType((*GetTxsEventResponse)(nil), "lbm.tx.v1beta1.GetTxsEventResponse")
	proto.RegisterType((*BroadcastTxRequest)(nil), "lbm.tx.v1beta1.BroadcastTxRequest")
	proto.RegisterType((*BroadcastTxResponse)(nil), "lbm.tx.v1beta1.BroadcastTxResponse")
	proto.RegisterType((*SimulateRequest)(nil), "lbm.tx.v1beta1.SimulateRequest")
	proto.RegisterType((*SimulateResponse)(nil), "lbm.tx.v1beta1.SimulateResponse")
	proto.RegisterType((*GetTxRequest)(nil), "lbm.tx.v1beta1.GetTxRequest")
	proto.RegisterType((*GetTxResponse)(nil), "lbm.tx.v1beta1.GetTxResponse")
}
...
var fileDescriptor_6fc6bd78191bf1b3 = []byte{
	...
	0xd2, 0x0d, 0xb2, 0xe1, 0xc4, 0x58, 0x05, 0x1f, 0xe2, 0x73, 0xa0, 0x8e, 0xda, 0x6e, 0xaa, 0x4a,
	0xdd, 0x56, 0xea, 0x8f, 0x6a, 0x97, 0x91, 0xda, 0x45, 0x97, 0x55, 0xd2, 0x1f, 0x52, 0xf9, 0xf8,
	0xf0, 0x32, 0x10, 0x45, 0xdd, 0xcd, 0x30, 0xdf, 0xcc, 0x37, 0xf3, 0x8d, 0xcf, 0x00, 0xd9, 0x96,
	0xd9, 0xd6, 0x98, 0xa7, 0xf5, 0x76, 0x4c, 0xcc, 0x8c, 0x1d, 0x8d, 0x62, 0xb7, 0x67, 0xd7, 0xb1,
	0xda, 0x71, 0x09, 0x23, 0x68, 0xb5, 0x65, 0xb6, 0x55, 0xe6, 0xa9, 0x22, 0x9a, 0xc9, 0x5a, 0x84,
	0x58, 0x2d, 0xac, 0x19, 0x1d, 0x5b, 0x33, 0x1c, 0x87, 0x30, 0x83, 0xd9, 0xc4, 0xa1, 0x01, 0x3a,
	...
	,
	...
	0x8e, 0x6e, 0x28, 0x69, 0x2d, 0x7c, 0x15, 0x05, 0x72, 0x4f, 0xda, 0x46, 0x4d, 0x98, 0xe7, 0xb2,
	...
	0x5e, 0xe6, 0x2c, 0x9b, 0x35, 0xbb, 0xa6, 0x5a, 0x27, 0x6d, 0xad, 0x65, 0x3b, 0xd8, 0xcf, 0x7e,
	0x44, 0x1b, 0xaf, 0x34, 0x76, 0xd5, 0xc1, 0x54, 0x63, 0x9e, 0xb9, 0xc0, 0xff, 0x05, 0x1e, 0xff,
	0x0e, 0x00, 0x00, 0xff, 0xff, 0x4c, 0xf0, 0x89, 0xe3, 0xcd, 0x06, 0x00, 0x00,
}
...
func (c *serviceClient) Simulate(ctx context.Context, in *SimulateRequest, opts ...grpc.CallOption) (*SimulateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/lbm.tx.v1beta1.Service/Simulate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) GetTx(ctx context.Context, in *GetTxRequest, opts ...grpc.CallOption) (*GetTxResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/lbm.tx.v1beta1.Service/GetTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) BroadcastTx(ctx context.Context, in *BroadcastTxRequest, opts ...grpc.CallOption) (*BroadcastTxResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/lbm.tx.v1beta1.Service/BroadcastTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) GetTxsEvent(ctx context.Context, in *GetTxsEventRequest, opts ...grpc.CallOption) (*GetTxsEventResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/lbm.tx.v1beta1.Service/GetTxsEvent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Service_Simulate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lbm.tx.v1beta1.Service/Simulate",
	}
...
func _Service_GetTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lbm.tx.v1beta1.Service/GetTx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Service_GetTxsEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lbm.tx.v1beta1.Service/GetTxsEvent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
