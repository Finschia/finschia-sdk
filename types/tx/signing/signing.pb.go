...
// source: lbm/tx/signing/v1/signing.proto
...
func (SignMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_8769df9121cc8530, []int{0}
}
...
func (*SignatureDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_8769df9121cc8530, []int{1}
}
...
func (*SignatureDescriptor_Data) Descriptor() ([]byte, []int) {
	return fileDescriptor_8769df9121cc8530, []int{1, 0}
}
...
type SignatureDescriptor_Data_Single struct {
	...
	Mode SignMode `protobuf:"varint,1,opt,name=mode,proto3,enum=lbm.tx.signing.v1.SignMode" json:"mode,omitempty"`
...
func (*SignatureDescriptor_Data_Single) Descriptor() ([]byte, []int) {
	return fileDescriptor_8769df9121cc8530, []int{1, 0, 0}
}
...
func (*SignatureDescriptor_Data_Multi) Descriptor() ([]byte, []int) {
	return fileDescriptor_8769df9121cc8530, []int{1, 0, 1}
}
...
func init() {
	proto.RegisterEnum("lbm.tx.signing.v1.SignMode", SignMode_name, SignMode_value)
	proto.RegisterType((*SignatureDescriptors)(nil), "lbm.tx.signing.v1.SignatureDescriptors")
	proto.RegisterType((*SignatureDescriptor)(nil), "lbm.tx.signing.v1.SignatureDescriptor")
	proto.RegisterType((*SignatureDescriptor_Data)(nil), "lbm.tx.signing.v1.SignatureDescriptor.Data")
	proto.RegisterType((*SignatureDescriptor_Data_Single)(nil), "lbm.tx.signing.v1.SignatureDescriptor.Data.Single")
	proto.RegisterType((*SignatureDescriptor_Data_Multi)(nil), "lbm.tx.signing.v1.SignatureDescriptor.Data.Multi")
}

func init() { proto.RegisterFile("lbm/tx/signing/v1/signing.proto", fileDescriptor_8769df9121cc8530) }

var fileDescriptor_8769df9121cc8530 = []byte{
	// 539 bytes of a gzipped FileDescriptorProto
	,
}
