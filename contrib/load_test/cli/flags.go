...
const (
	...
	FlagMaxWorkers          = "max_workers"
	FlagOutputDir           = "output"
	FlagPrepareTargetURL    = "prepare_target_url"
	FlagLoadTargetURL       = "load_target_url"
	FlagChainID             = "chain_id"
	FlagCoinName            = "coin_name"
	FlagMasterMnemonic      = "master_mnemonic"
	FlagSlaves              = "slaves"
	FlagPort                = "port"
	FlagThroughputThreshold = "throughput_threshold"
