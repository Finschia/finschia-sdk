...
func NewSimApp(
	...
	// todo: remove this jwksMap test data
	jwKsMap.AddJWK(&zkauthtypes.JWK{
		Kty: "RSA",
		E:   "AQAB",
	...
	zkauthKeeper := zkauthkeeper.NewKeeper(appCodec, keys[zkauthtypes.StoreKey], *jwKsMap, zkAuthVerifier, "")
