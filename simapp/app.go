...
func NewSimApp(
	...
	app.TokenKeeper = tokenkeeper.NewKeeper(appCodec, keys[token.StoreKey], classKeeper)
	app.CollectionKeeper = collectionkeeper.NewKeeper(appCodec, keys[collection.StoreKey], classKeeper)
