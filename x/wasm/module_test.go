...
func TestHandleStoreAndInstantiate(t *testing.T) {
	...
	assert.Equal(t, "instantiate_contract", res.Events[4].Type)
	assertAttribute(t, "code_id", "1", res.Events[4].Attributes[0])
	assertAttribute(t, "contract_address", contractBech32Addr, res.Events[4].Attributes[1])
