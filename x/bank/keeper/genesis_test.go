...
func (suite *IntegrationTestSuite) TestExportGenesis() {
	...
	for i := range []int{1, 2} {
		...
		accAddr := sdk.AccAddress(expectedBalances[i].Address)
...
func (suite *IntegrationTestSuite) getTestBalances() []types.Balance {
	...
	return []types.Balance{
		{Address: addr2, Coins: sdk.Coins{sdk.NewInt64Coin("testcoin1", 32), sdk.NewInt64Coin("testcoin2", 34)}},
		{Address: addr1, Coins: sdk.Coins{sdk.NewInt64Coin("testcoin3", 10)}},
	}
