...
// source: lbm/crisis/v1beta1/tx.proto
...
func (*MsgVerifyInvariant) Descriptor() ([]byte, []int) {
	return fileDescriptor_6b731fdb4a263d09, []int{0}
}
...
func (*MsgVerifyInvariantResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_6b731fdb4a263d09, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgVerifyInvariant)(nil), "lbm.crisis.v1beta1.MsgVerifyInvariant")
	proto.RegisterType((*MsgVerifyInvariantResponse)(nil), "lbm.crisis.v1beta1.MsgVerifyInvariantResponse")
}

func init() { proto.RegisterFile("lbm/crisis/v1beta1/tx.proto", fileDescriptor_6b731fdb4a263d09) }

var fileDescriptor_6b731fdb4a263d09 = []byte{
	...
	0xa9, 0xd0, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x12, 0xca, 0x49, 0xca, 0xd5, 0x83, 0x48, 0xea,
	...
	0x4a, 0x93, 0xf4, 0x92, 0xf3, 0x73, 0xf5, 0x73, 0x32, 0xf3, 0x52, 0xf5, 0x73, 0x92, 0x72, 0x75,
	0x8b, 0x53, 0xb2, 0xf5, 0x2b, 0x60, 0x51, 0x5b, 0x52, 0x59, 0x90, 0x5a, 0x9c, 0xc4, 0x06, 0x8e,
	0x2c, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x08, 0x0e, 0x17, 0x2a, 0xf5, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) VerifyInvariant(ctx context.Context, in *MsgVerifyInvariant, opts ...grpc.CallOption) (*MsgVerifyInvariantResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/lbm.crisis.v1beta1.Msg/VerifyInvariant", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_VerifyInvariant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lbm.crisis.v1beta1.Msg/VerifyInvariant",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "lbm.crisis.v1beta1.Msg",
	...
	Metadata: "lbm/crisis/v1beta1/tx.proto",
}
