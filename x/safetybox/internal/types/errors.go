...
var (
	...
	ErrSafetyBoxContractIDRequired      = sdkerrors.Register(ModuleName, 22, "ContractID is required")
	ErrSafetyBoxIncorrectContractID     = sdkerrors.Register(ModuleName, 23, "The safety box doesn't accept the ContractID")
	ErrSafetyBoxInvalidAmount           = sdkerrors.Register(ModuleName, 24, "Invalid token amount")
	ErrSafetyBoxTokenNotExist           = sdkerrors.Register(ModuleName, 25, "Token does not exist")
)
