...
func NewQuerier(keeper Keeper) sdk.Querier {
	return func(ctx sdk.Context, path []string, req abci.RequestQuery) ([]byte, error) {
		...
		default:
			return nil, sdkerrors.Wrap(sdkerrors.ErrUnknownRequest, "unknown safetybox query endpoint")
		}
	}
}

func querySafetyBox(ctx sdk.Context, req abci.RequestQuery, keeper Keeper) ([]byte, error) {
...
func queryAccountRole(ctx sdk.Context, req abci.RequestQuery, keeper Keeper) ([]byte, error) {
