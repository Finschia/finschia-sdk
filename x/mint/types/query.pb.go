...
type QueryAnnualProvisionsResponse struct {
	...
	AnnualProvisions github_com_Finschia_finschia_sdk_types.Dec `protobuf:"bytes,1,opt,name=annual_provisions,json=annualProvisions,proto3,customtype=github.com/Finschia/finschia-sdk/types.Dec" json:"annual_provisions"`
}
