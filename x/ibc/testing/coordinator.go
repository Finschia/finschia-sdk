...
func (coord *Coordinator) Setup(
	...
	clientA, clientB, connA, connB := coord.SetupClientConnections(chainA, chainB, exported.Ostracon)
...
func (coord *Coordinator) SendPacket(
	...
	return coord.UpdateClient(
		counterparty, source,
		counterpartyClientID, exported.Ostracon,
	)
}
...
func (coord *Coordinator) ConnOpenTry(
	...
	return coord.UpdateClient(
		counterparty, source,
		counterpartyConnection.ClientID, exported.Ostracon,
	)
}
...
func (coord *Coordinator) ChanOpenInitOnBothChains(
	...
	if err := coord.UpdateClient(
		source, counterparty,
		connection.ClientID, exported.Ostracon,
	); err != nil {
		return sourceChannel, counterpartyChannel, err
	}
...
func (coord *Coordinator) ChanOpenTry(
	...
	return coord.UpdateClient(
		counterparty, source,
		connection.CounterpartyClientID, exported.Ostracon,
	)
}
...
func (coord *Coordinator) ChanOpenAck(
	...
	return coord.UpdateClient(
		counterparty, source,
		sourceChannel.CounterpartyClientID, exported.Ostracon,
	)
}
...
func (coord *Coordinator) ChanCloseInit(
	...
	return coord.UpdateClient(
		counterparty, source,
		channel.CounterpartyClientID, exported.Ostracon,
	)
}
...
func (coord *Coordinator) SetChannelClosed(
	...
	return coord.UpdateClient(
		counterparty, source,
		testChannel.CounterpartyClientID, exported.Ostracon,
	)
}
