...
type Proposal struct {
	...
	NewFieldSample   uint64                              `protobuf:"varint,10,opt,name=new_field_sample,json=newFieldSample,proto3" json:"new_field_sample" yaml:"new_field_sample"`
}
...
var fileDescriptor_945deb6a098bdba3 = []byte{
	...
	,
}
...
func (this *Proposal) Equal(that interface{}) bool {
	...
	if this.NewFieldSample != that1.NewFieldSample {
		return false
	}
	return true
}
...
func (m *Proposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.NewFieldSample != 0 {
		i = encodeVarintGov(dAtA, i, uint64(m.NewFieldSample))
		i--
		dAtA[i] = 0x50
	}
...
func (m *Proposal) Size() (n int) {
	...
	n += 1 + l + sovGov(uint64(l))
	if m.NewFieldSample != 0 {
		n += 1 + sovGov(uint64(m.NewFieldSample))
	}
	return n
}
...
func (m *Proposal) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NewFieldSample", wireType)
			}
			m.NewFieldSample = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NewFieldSample |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
