...
type MsgSubmitProposal struct {
	...
	InitialDeposit github_com_Finschia_finschia_sdk_types.Coins `protobuf:"bytes,2,rep,name=initial_deposit,json=initialDeposit,proto3,castrepeated=github.com/Finschia/finschia-sdk/types.Coins" json:"initial_deposit" yaml:"initial_deposit"`
