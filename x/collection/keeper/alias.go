...
func (k Keeper) iterateStatisticsImpl(ctx sdk.Context, prefix []byte, fn func(contractID, classID string, amount math.Int) (stop bool)) {
	iterator := k.iterWithPrefix(ctx, prefix)
	defer iterator.Close()
...
func (k Keeper) iterateContractSupplies(ctx sdk.Context, contractID string, fn func(classID string, amount math.Int) (stop bool)) {
	k.iterateStatisticsImpl(ctx, statisticKeyPrefixByContractID(supplyKeyPrefix, contractID), func(_, classID string, amount math.Int) (stop bool) {
...
func (k Keeper) iterateContractBurnts(ctx sdk.Context, contractID string, fn func(classID string, amount math.Int) (stop bool)) {
	k.iterateStatisticsImpl(ctx, statisticKeyPrefixByContractID(burntKeyPrefix, contractID), func(_, classID string, amount math.Int) (stop bool) {
		return fn(classID, amount)
	})
}
