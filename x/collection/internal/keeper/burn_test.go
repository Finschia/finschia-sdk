...
func TestKeeper_BurnFT(t *testing.T) {
	...
	require.EqualError(t, keeper.BurnFT(ctx, wrongContractID, addr1, types.NewCoins(types.NewCoin(defaultTokenIDFT, sdk.NewInt(1)))), sdkerrors.Wrapf(types.ErrTokenNoPermission, "Account: %s, Permission: %s", addr1.String(), types.NewBurnPermission().String()).Error())
	require.EqualError(t, keeper.BurnFT(ctx, defaultContractID, addr2, types.NewCoins(types.NewCoin(defaultTokenIDFT, sdk.NewInt(1)))), sdkerrors.Wrapf(types.ErrTokenNoPermission, "Account: %s, Permission: %s", addr2.String(), types.NewBurnPermission().String()).Error())
	require.EqualError(t, keeper.BurnFT(ctx, defaultContractID, addr3, types.NewCoins(types.NewCoin(defaultTokenIDFT, sdk.NewInt(1)))), sdkerrors.Wrapf(types.ErrTokenNoPermission, "Account: %s, Permission: %s", addr3.String(), types.NewBurnPermission().String()).Error())
	...
	require.EqualError(t, keeper.BurnFT(ctx, defaultContractID, addr2, types.NewCoins(types.NewCoin(defaultTokenIDFT, sdk.NewInt(1)))), sdkerrors.Wrapf(types.ErrTokenNoPermission, "Account: %s, Permission: %s", addr2, types.NewBurnPermission()).Error())
...
func TestKeeper_BurnFTFrom(t *testing.T) {
	...
	require.EqualError(t, keeper.BurnFTFrom(ctx, defaultContractID, addr2, addr1, types.NewCoins(types.NewCoin(defaultTokenIDFT, sdk.NewInt(1)))), sdkerrors.Wrapf(types.ErrTokenNoPermission, "Account: %s, Permission: %s", addr2, types.NewBurnPermission()).Error())
...
func TestMintBurn(t *testing.T) {
	...
	require.EqualError(t, keeper.BurnNFT(ctx, defaultContractID, addr3, defaultTokenID1), sdkerrors.Wrapf(types.ErrTokenNoPermission, "Account: %s, Permission: %s", addr3.String(), types.NewBurnPermission().String()).Error())
}
...
func TestBurnNFTFromFailure3(t *testing.T) {
	...
	// test burnNFTFrom fail
	require.EqualError(t, keeper.BurnNFTFrom(ctx, defaultContractID, addr2, addr3, defaultTokenID1), sdkerrors.Wrapf(types.ErrTokenNoPermission, "Account: %s, Permission: %s", addr2.String(), types.NewBurnPermission().String()).Error())
	require.EqualError(t, keeper.BurnFTFrom(ctx, defaultContractID, addr2, addr3, types.NewCoins(types.NewCoin(defaultTokenIDFT, sdk.NewInt(1)))), sdkerrors.Wrapf(types.ErrTokenNoPermission, "Account: %s, Permission: %s", addr2.String(), types.NewBurnPermission().String()).Error())
}
