...
func (m *GenesisState) GetClassState() *ClassState {
	if m != nil {
		return m.ClassState
	}
	return nil
...
type NextClassIDs struct {
	...
	Fungible cosmossdk_io_math.Uint `protobuf:"bytes,2,opt,name=fungible,proto3,customtype=cosmossdk.io/math.Uint" json:"fungible"`
	// id for the non-fungible tokens.
	NonFungible cosmossdk_io_math.Uint `protobuf:"bytes,3,opt,name=non_fungible,json=nonFungible,proto3,customtype=cosmossdk.io/math.Uint" json:"non_fungible"`
}
...
type ClassState struct {
	...
	Nonce cosmossdk_io_math.Uint `protobuf:"bytes,1,opt,name=nonce,proto3,customtype=cosmossdk.io/math.Uint" json:"nonce"`
	// ids represents the issued ids.
	Ids []string `protobuf:"bytes,2,rep,name=ids,proto3" json:"ids,omitempty"`
}

func (m *ClassState) Reset()         { *m = ClassState{} }
func (m *ClassState) String() string { return proto.CompactTextString(m) }
func (*ClassState) ProtoMessage()    {}
func (*ClassState) Descriptor() ([]byte, []int) {
	return fileDescriptor_2b8b3f666cffb1ec, []int{14}
}
func (m *ClassState) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ClassState) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ClassState.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ClassState) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ClassState.Merge(m, src)
}
func (m *ClassState) XXX_Size() int {
	return m.Size()
}
func (m *ClassState) XXX_DiscardUnknown() {
	xxx_messageInfo_ClassState.DiscardUnknown(m)
}

var xxx_messageInfo_ClassState proto.InternalMessageInfo

func (m *ClassState) GetIds() []string {
	if m != nil {
		return m.Ids
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*ClassState)(nil), "lbm.collection.v1.ClassState")
}
...
var fileDescriptor_2b8b3f666cffb1ec = []byte{
	...
	,
}
...
func (m *ClassState) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ClassState) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ClassState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ClassState) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ClassState: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ClassState: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
