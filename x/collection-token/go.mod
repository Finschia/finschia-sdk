module github.com/Finschia/finschia-sdk/x/collection-token
...
replace github.com/cosmos/cosmos-sdk v0.50.2 => github.com/Finschia/cosmos-sdk v0.0.0-20231211060251-d8fb76d4c267
