...
import (
	...
	"github.com/link-chain/link/x/nft/client/cli"
	"github.com/link-chain/link/x/nft/client/rest"
)
...
// func (AppModuleSimulation) RegisterStoreDecoder(sdr store.StoreDecoderRegistry) {
