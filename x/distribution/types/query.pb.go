...
func (m *QueryDelegationRewardsResponse) GetRewards() github_com_Finschia_finschia_sdk_types.DecCoins {
	if m != nil {
		return m.Rewards
	}
	return nil
...
type QueryDelegationTotalRewardsResponse struct {
	...
	Total github_com_Finschia_finschia_sdk_types.DecCoins `protobuf:"bytes,2,rep,name=total,proto3,castrepeated=github.com/Finschia/finschia-sdk/types.DecCoins" json:"total"`
}
...
func (m *QueryDelegationTotalRewardsResponse) GetTotal() github_com_Finschia_finschia_sdk_types.DecCoins {
	if m != nil {
		return m.Total
	}
	return nil
...
type QueryCommunityPoolResponse struct {
	...
	Pool github_com_Finschia_finschia_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=pool,proto3,castrepeated=github.com/Finschia/finschia-sdk/types.DecCoins" json:"pool"`
}
...
func (m *QueryCommunityPoolResponse) GetPool() github_com_Finschia_finschia_sdk_types.DecCoins {
	if m != nil {
		return m.Pool
	}
	return nil
