...
var (
	...
	ErrIsNotEnoughDepositAmount       = sdkerrors.Register(ModuleName, 9, "sequencer deposit is not enough.")
	ErrNotExistSequencer              = sdkerrors.Register(ModuleName, 10, "sequencer exist for this address")
	ErrNotFoundDeposit                = sdkerrors.Register(ModuleName, 11, "deposit not found")
)
