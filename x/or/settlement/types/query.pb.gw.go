...
var (
	pattern_Query_Challenge_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"finschia", "or", "settlement", "v1", "challenge", "challenge_id"}, "", runtime.AssumeColonVerbOpt(false)))
)
