...
type MsgCreateValidator struct {
	...
	MinSelfDelegation github_com_Finschia_finschia_sdk_types.Int `protobuf:"bytes,3,opt,name=min_self_delegation,json=minSelfDelegation,proto3,customtype=github.com/Finschia/finschia-sdk/types.Int" json:"min_self_delegation" yaml:"min_self_delegation"`
...
type MsgEditValidator struct {
	...
	// REF: #2373
	CommissionRate    *github_com_Finschia_finschia_sdk_types.Dec `protobuf:"bytes,3,opt,name=commission_rate,json=commissionRate,proto3,customtype=github.com/Finschia/finschia-sdk/types.Dec" json:"commission_rate,omitempty" yaml:"commission_rate"`
	MinSelfDelegation *github_com_Finschia_finschia_sdk_types.Int `protobuf:"bytes,4,opt,name=min_self_delegation,json=minSelfDelegation,proto3,customtype=github.com/Finschia/finschia-sdk/types.Int" json:"min_self_delegation,omitempty" yaml:"min_self_delegation"`
}
...
func (m *MsgEditValidator) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			var v github_com_Finschia_finschia_sdk_types.Dec
			m.CommissionRate = &v
		...
		case 4:
			...
			var v github_com_Finschia_finschia_sdk_types.Int
