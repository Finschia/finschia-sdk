...
type Params struct {
	FoundationTax cosmossdk_io_math.LegacyDec `protobuf:"bytes,1,opt,name=foundation_tax,json=foundationTax,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"foundation_tax"`
}
...
type PercentageDecisionPolicy struct {
	...
	Percentage cosmossdk_io_math.LegacyDec `protobuf:"bytes,1,opt,name=percentage,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"percentage"`
	// windows defines the different windows for voting and execution.
	Windows *DecisionPolicyWindows `protobuf:"bytes,2,opt,name=windows,proto3" json:"windows,omitempty"`
}
...
type FoundationInfo struct {
	...
	TotalWeight cosmossdk_io_math.LegacyDec `protobuf:"bytes,2,opt,name=total_weight,json=totalWeight,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"total_weight"`
...
type TallyResult struct {
	...
	YesCount cosmossdk_io_math.LegacyDec `protobuf:"bytes,1,opt,name=yes_count,json=yesCount,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"yes_count"`
	// abstain_count is the sum of abstainers.
	AbstainCount cosmossdk_io_math.LegacyDec `protobuf:"bytes,2,opt,name=abstain_count,json=abstainCount,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"abstain_count"`
	// no is the sum of no votes.
	NoCount cosmossdk_io_math.LegacyDec `protobuf:"bytes,3,opt,name=no_count,json=noCount,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"no_count"`
	// no_with_veto_count is the sum of veto.
	NoWithVetoCount cosmossdk_io_math.LegacyDec `protobuf:"bytes,4,opt,name=no_with_veto_count,json=noWithVetoCount,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"no_with_veto_count"`
}
...
type Pool struct {
	Treasury github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=treasury,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.DecCoins" json:"treasury"`
}
...
func (m *Pool) GetTreasury() github_com_cosmos_cosmos_sdk_types.DecCoins {
	if m != nil {
		return m.Treasury
	}
	return nil
...
var fileDescriptor_1980496a233f02f4 = []byte{
	...
	,
}
...
func (m *Proposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n7, err7 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.VotingPeriodEnd, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.VotingPeriodEnd):])
	if err7 != nil {
		return 0, err7
	}
	i -= n7
	...
	n9, err9 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.SubmitTime, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.SubmitTime):])
	if err9 != nil {
		return 0, err9
	}
	i -= n9
