...
const (
	// GRANTER_UNSPECIFIED defines a empty granter type.
	GRANTER_UNSPECIFIED Granter = 0
	// GRANTER_GOVERNANCE defines a granter type of governance.
	GRANTER_GOVERNANCE Granter = 1
	// GRANTER_FOUNDATION defines a granter type of foundation.
	GRANTER_FOUNDATION Granter = 2
)

var Granter_name = map[int32]string{
	0: "GRANTER_UNSPECIFIED",
	1: "GRANTER_GOVERNANCE",
	2: "GRANTER_FOUNDATION",
}

var Granter_value = map[string]int32{
	"GRANTER_UNSPECIFIED": 0,
	"GRANTER_GOVERNANCE":  1,
	"GRANTER_FOUNDATION":  2,
}

func (x Granter) String() string {
	return proto.EnumName(Granter_name, int32(x))
}

func (Granter) EnumDescriptor() ([]byte, []int) {
...
func init() {
	proto.RegisterEnum("lbm.foundation.v1.Granter", Granter_name, Granter_value)
...
var fileDescriptor_1980496a233f02f4 = []byte{
	...
	,
}
