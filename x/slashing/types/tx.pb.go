...
// source: lbm/slashing/v1/tx.proto
...
func (*MsgUnjail) Descriptor() ([]byte, []int) {
	return fileDescriptor_cbd6214a0b0253a8, []int{0}
}
...
func (*MsgUnjailResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_cbd6214a0b0253a8, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUnjail)(nil), "lbm.slashing.v1.MsgUnjail")
	proto.RegisterType((*MsgUnjailResponse)(nil), "lbm.slashing.v1.MsgUnjailResponse")
}

func init() { proto.RegisterFile("lbm/slashing/v1/tx.proto", fileDescriptor_cbd6214a0b0253a8) }

var fileDescriptor_cbd6214a0b0253a8 = []byte{
	...
	,
	...
	0xfa, 0x39, 0x99, 0x79, 0xa9, 0xfa, 0x39, 0x49, 0xb9, 0xba, 0xc5, 0x29, 0xd9, 0xfa, 0x15, 0x88,
	0x70, 0x2b, 0xa9, 0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03, 0x87, 0x88, 0x31, 0x20, 0x00, 0x00, 0xff,
	0xff, 0x1a, 0xdb, 0x33, 0x19, 0x54, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) Unjail(ctx context.Context, in *MsgUnjail, opts ...grpc.CallOption) (*MsgUnjailResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/lbm.slashing.v1.Msg/Unjail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Unjail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lbm.slashing.v1.Msg/Unjail",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "lbm.slashing.v1.Msg",
	...
	Metadata: "lbm/slashing/v1/tx.proto",
}
