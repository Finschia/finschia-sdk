...
// source: lbm/slashing/v1beta1/tx.proto
...
func (*MsgUnjail) Descriptor() ([]byte, []int) {
	return fileDescriptor_7d758780fe1256de, []int{0}
}
...
func (*MsgUnjailResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7d758780fe1256de, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUnjail)(nil), "lbm.slashing.v1beta1.MsgUnjail")
	proto.RegisterType((*MsgUnjailResponse)(nil), "lbm.slashing.v1beta1.MsgUnjailResponse")
}

func init() { proto.RegisterFile("lbm/slashing/v1beta1/tx.proto", fileDescriptor_7d758780fe1256de) }

var fileDescriptor_7d758780fe1256de = []byte{
	...
	0xf5, 0xe0, 0x3a, 0xa5, 0xd4, 0x09, 0x28, 0x80, 0x19, 0xed, 0xe4, 0xb9, 0xe2, 0x91, 0x1c, 0xe3,
	...
	0xa7, 0x64, 0xeb, 0x97, 0x19, 0xe9, 0x57, 0x20, 0x82, 0xb3, 0xa4, 0xb2, 0x20, 0xb5, 0x38, 0x89,
	0x0d, 0x1c, 0x3c, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x2a, 0x10, 0x54, 0xf1, 0x6b, 0x01,
	0x00, 0x00,
}
...
func (c *msgClient) Unjail(ctx context.Context, in *MsgUnjail, opts ...grpc.CallOption) (*MsgUnjailResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/lbm.slashing.v1beta1.Msg/Unjail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Unjail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lbm.slashing.v1beta1.Msg/Unjail",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "lbm.slashing.v1beta1.Msg",
	...
	Metadata: "lbm/slashing/v1beta1/tx.proto",
}
