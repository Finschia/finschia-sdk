...
func init() {
	proto.RegisterType((*MsgEmpty)(nil), "lbm.auth.v1.MsgEmpty")
	proto.RegisterType((*MsgEmptyResponse)(nil), "lbm.auth.v1.MsgEmptyResponse")
}
...
var fileDescriptor_9e8c33a1d6e53fde = []byte{
	...
	,
	...
	0xaf, 0x80, 0xf8, 0xb9, 0xa4, 0xb2, 0x20, 0xb5, 0x38, 0x89, 0x0d, 0xec, 0x65, 0x63, 0x40, 0x00,
	0x00, 0x00, 0xff, 0xff, 0x38, 0x03, 0x1d, 0x39, 0x45, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) Empty(ctx context.Context, in *MsgEmpty, opts ...grpc.CallOption) (*MsgEmptyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/lbm.auth.v1.Msg/Empty", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Empty_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lbm.auth.v1.Msg/Empty",
	}
