...
// source: lbm/auth/v1beta1/tx.proto
...
func (*MsgEmpty) Descriptor() ([]byte, []int) {
	return fileDescriptor_8daee694c69402a3, []int{0}
}
...
func (*MsgEmptyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_8daee694c69402a3, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgEmpty)(nil), "lbm.auth.v1beta1.MsgEmpty")
	proto.RegisterType((*MsgEmptyResponse)(nil), "lbm.auth.v1beta1.MsgEmptyResponse")
}

func init() { proto.RegisterFile("lbm/auth/v1beta1/tx.proto", fileDescriptor_8daee694c69402a3) }

var fileDescriptor_8daee694c69402a3 = []byte{
	...
	0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x12, 0xc8, 0x49, 0xca, 0xd5, 0x03, 0x49, 0xe9, 0x41, 0xa5,
	...
	0xc9, 0x28, 0x4d, 0xd2, 0x4b, 0xce, 0xcf, 0xd5, 0xcf, 0xc9, 0xcc, 0x4b, 0xd5, 0xcf, 0x49, 0xca,
	0xd5, 0x2d, 0x4e, 0xc9, 0xd6, 0x2f, 0x33, 0xd2, 0xaf, 0x80, 0x84, 0x42, 0x49, 0x65, 0x41, 0x6a,
	0x71, 0x12, 0x1b, 0xd8, 0xff, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x63, 0xbc, 0x35, 0x50,
	0x61, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) Empty(ctx context.Context, in *MsgEmpty, opts ...grpc.CallOption) (*MsgEmptyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/lbm.auth.v1beta1.Msg/Empty", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Empty_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lbm.auth.v1beta1.Msg/Empty",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "lbm.auth.v1beta1.Msg",
	...
	Metadata: "lbm/auth/v1beta1/tx.proto",
}
