...
// source: lbm/evidence/v1beta1/tx.proto
...
func (*MsgSubmitEvidence) Descriptor() ([]byte, []int) {
	return fileDescriptor_11f17dcfee8ec832, []int{0}
}
...
func (*MsgSubmitEvidenceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_11f17dcfee8ec832, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgSubmitEvidence)(nil), "lbm.evidence.v1beta1.MsgSubmitEvidence")
	proto.RegisterType((*MsgSubmitEvidenceResponse)(nil), "lbm.evidence.v1beta1.MsgSubmitEvidenceResponse")
}

func init() { proto.RegisterFile("lbm/evidence/v1beta1/tx.proto", fileDescriptor_11f17dcfee8ec832) }

var fileDescriptor_11f17dcfee8ec832 = []byte{
	...
	0xd4, 0x2f, 0xa9, 0xd0, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x12, 0xc9, 0x49, 0xca, 0xd5, 0x83,
	...
	0x0f, 0x5b, 0x48, 0xe9, 0x61, 0x98, 0x2e, 0xa5, 0x4f, 0xa4, 0x42, 0x98, 0x33, 0x9c, 0x3c, 0x57,
	...
	0xa4, 0x5c, 0xdd, 0xe2, 0x94, 0x6c, 0xfd, 0x32, 0x23, 0xfd, 0x0a, 0x44, 0xc4, 0x96, 0x54, 0x16,
	0xa4, 0x16, 0x27, 0xb1, 0x81, 0x83, 0xc7, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0xdd, 0xdf, 0xc0,
	0x1f, 0xf5, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) SubmitEvidence(ctx context.Context, in *MsgSubmitEvidence, opts ...grpc.CallOption) (*MsgSubmitEvidenceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/lbm.evidence.v1beta1.Msg/SubmitEvidence", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SubmitEvidence_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lbm.evidence.v1beta1.Msg/SubmitEvidence",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "lbm.evidence.v1beta1.Msg",
	...
	Metadata: "lbm/evidence/v1beta1/tx.proto",
}
