...
func TestFullAppSimulation(t *testing.T) {
	...
	app := NewLinkApp(logger, db, nil, true, simapp.FlagPeriodValue, fauxMerkleModeOpt)
...
func TestAppImportExport(t *testing.T) {
	...
	newApp := NewLinkApp(log.NewNopLogger(), newDB, nil, true, simapp.FlagPeriodValue, fauxMerkleModeOpt)
