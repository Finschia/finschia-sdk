...
var (
	pattern_Service_GetNodeInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"cosmos", "base", "ostracon", "v1beta1", "node_info"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Service_GetSyncing_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"cosmos", "base", "ostracon", "v1beta1", "syncing"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Service_GetLatestBlock_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"cosmos", "base", "ostracon", "v1beta1", "blocks", "latest"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Service_GetBlockByHeight_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"cosmos", "base", "ostracon", "v1beta1", "blocks", "height"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Service_GetLatestValidatorSet_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"cosmos", "base", "ostracon", "v1beta1", "validatorsets", "latest"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Service_GetValidatorSetByHeight_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"cosmos", "base", "ostracon", "v1beta1", "validatorsets", "height"}, "", runtime.AssumeColonVerbOpt(true)))
)
