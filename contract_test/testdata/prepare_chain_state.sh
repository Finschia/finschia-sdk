...
echo ${FAUCET_PASSWORD} | ./build/linkcli keys import faucet ./contract_test/testdata/faucet.key --home /tmp/contract_test/.linkcli

./build/linkd --home /tmp/contract_test/.linkd add-genesis-account $(./build/linkcli --home /tmp/contract_test/.linkcli keys show faucet -a) 9223372036854775807link,1stake
sleep 3s
