...
Example:
	linkd testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "linkd",
		"Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "linkcli",
...
func InitTestnet(cmd *cobra.Command, config *tmconfig.Config, cdc *codec.Codec,
	...
	for i := 0; i < numValidators; i++ {
		...
		keyPass, err := input.GetPassword(prompt, inBuf)
		if err != nil && keyPass != "" {
