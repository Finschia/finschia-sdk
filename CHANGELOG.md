...
## [Unreleased](https://github.com/Finschia/finschia-sdk/compare/v0.47.3...HEAD)
...
>>>>>>> 78499290a (fix(server): properly parse multiple gas config(backport cosmos/cosmos-sdk#18537) (#1337))
