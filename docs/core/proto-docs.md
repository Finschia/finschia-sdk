...
| `funds` | [lfb.base.v1beta1.Coin](#lfb.base.v1beta1.Coin) | repeated | Funds coins that are transferred to the contract on execution |
...
| `funds` | [lfb.base.v1beta1.Coin](#lfb.base.v1beta1.Coin) | repeated | Funds coins that are transferred to the contract on instantiation |
